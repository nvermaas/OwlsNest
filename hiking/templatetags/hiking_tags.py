...
def overnights(hike):
    ...
    wild_campsite_nights_html = f"<i class='fas fa-campground' style='color: green;'></i> {hike.wild_campsite_nights} " \
        if hike.wild_campsite_nights else ""
    campground_nights_html = f"<i class='fas fa-campground' style='color: blue;'></i> {hike.campground_nights} " \
    ...
    overnights_html = wild_rough_nights_html + wild_campsite_nights_html + campground_nights_html + indoor_nights_html
